...
public class Crawler4ZhishikuFJ extends BaseCrawler {
	public Crawler4ZhishikuFJ() {
		super("/" + Crawler4ZhishikuFJ.class.getName().replace(".", "/") + ".json");
	}
	...
	private static final String DETAIL_REGEXP = "^http://www\\.tcminformatics\\.org/wiki/index\\.php/fangjibaike/search\\?kw=.*$";

	public static final String URL_PRF = "http://www.tcminformatics.org/wiki/index.php/fangjibaike/search?kw=";
	...
	private void visitBBSPage(String url) {
		...
		logger.info("url:" + url);
		logger.info("time:" + StringUtils.stringinsert(time, "-", 8));
