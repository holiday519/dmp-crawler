...
public class CrawlerConfig {
	...
	public Login getLoginConf() {
		return loginConf;
	}

	public void setLoginConf(Login loginConf) {
		this.loginConf = loginConf;
	}

	public Proxy getProxyConf() {
		return proxyConf;
	}

	public void setProxyConf(Proxy proxyConf) {
